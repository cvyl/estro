...
export default function DosageComponent() {
	...
	const handleEstrogenTypeChange = (
	...
	const handleLogDosage = () => {
		setDosageHistory([
			...dosageHistory,
			{ date: selectedDate, dosage, type: estrogenType }
		])
		setDosage(0)
		setEstrogenType('')
	}
			...
			<div className='grid flex-1 grid-cols-1 gap-8 p-8 lg:grid-cols-2'>
				<div className='flex flex-col gap-4'>
					<div className='rounded-lg bg-white p-4 shadow dark:bg-gray-900'>
						<h2 className='mb-4 text-lg font-bold'>Log Dosage</h2>
						<div className='grid grid-cols-2 gap-4'>
							...
							<div>
								<Select
									value={estrogenType}
									onValueChange={() => handleEstrogenTypeChange}
								></Select>
								<Select
									value={estrogenType}
									onValueChange={() => handleEstrogenTypeChange}
								>
									...
									<SelectContent>
										<SelectItem value='Estradiol Enanthate'>
											Estradiol Enanthate
										</SelectItem>
										<SelectItem value='Estradiol Gel'>Estradiol Gel</SelectItem>
										<SelectItem value='Estradiol Pills'>
											Estradiol Pills
										</SelectItem>
									</SelectContent>
								</Select>
				...
				<div className='flex flex-col gap-4'>
					<div className='rounded-lg bg-white p-4 shadow dark:bg-gray-900'>
						<h2 className='mb-4 text-lg font-bold'>Dosage History</h2>
						<Table>
							<TableHeader>
								<TableRow>
					...
					<div className='flex-1 rounded-lg bg-white p-4 shadow dark:bg-gray-900'>
						<h2 className='mb-4 text-lg font-bold'>Dosage Over Time</h2>
						<div>
							<div>
